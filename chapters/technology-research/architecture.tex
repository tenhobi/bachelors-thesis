...
tříd, struktur či vrstev aplikace.
...
protože právě tato vrstva je v aplikaci nejdůležitější a děje se v ní
implementace nových funcionalit, změn či oprav.
Oddělení závislosti na konkrétní implementaci databází či dalších služeb
je logický a chytrý krok,
jelikož to jsou pouze detaily.
Oddělením těchto závislostí na služby se navíc umožní snadná náhrada
za služby jiné.
\cite{architecture}
